...
describe('PlacesView - Rendu de base', () => {
...
describe('PlacesView - Boutons d\'export', () => {
...
describe('PlacesView - Données vides', () => {
...
describe('PlacesView - Props requises', () => {
