...
const OverviewView = ({
  ...
  return (
    <div style={{
      ...
      gridTemplateRows: 'minmax(300px, auto) minmax(250px, auto) minmax(200px, auto) minmax(200px, auto)',
      gap: '2px',
      ...
      {/* Panel Nuage de mots */}
      <NavigationPanel
        config={panelConfig.wordcloud}
        isActive={false}
        onClick={() => navigateToView('wordcloud')}
      >
        <div style={{ textAlign: 'center' }}>
          <div style={{ 
            fontSize: '2.5rem', 
          ...
          <div style={{
            ...
            {analytics.keyTerms.slice(0, 5).map((term, index) => (
              <div key={term.term} style={{
