...
describe('DomainsView - Rendu de base', () => {
  ...
  it('devrait afficher le titre de la section', () => {
    ...
    expect(screen.getByText(/Répartition par domaines/i)).toBeInTheDocument();
  });
  ...
  it('devrait rendre le graphique', () => {
    ...
    // Le chart est rendu (DomainChart)
...
describe('DomainsView - Boutons d\'export', () => {
...
describe('DomainsView - Données vides', () => {
...
describe('DomainsView - Props requises', () => {
